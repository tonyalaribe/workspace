    ...
    return (
      <nav className="bg-navy w-100 fixed shadow-4 pa3 ph4 white-80 dib">
        ...
        <div className="dib pa2 fr pr5">
          <Link to={"/workspaces/"+CurrentWorkspace.id+"/new_submission"} className="white-70  link pa2 ba hover-white">
            New Submission
          </Link>
          <Link to={"/workspaces/"+CurrentWorkspace.id+"/"} className="white-70  link pa2 mh2 hover-white">
            All Submissions
          </Link>
