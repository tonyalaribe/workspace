        ...
        return (
          <div className="pr1 pb1 w-25 fl" key={key}>
              <div className="h-100 ba b--black-20 tc pa2">
                ...
                <img src={GetFileRepresentativeImage(name)} className="w3 h3 dib v-mid" alt="file representative logo"/>
                <small className="db link pointer truncate pb1 navy pa1" >{name}</small>
              </div>
          </div>
        );
      })}
...
class FileWidget extends Component {
  ...
  render() {
    ...
    return (
      <div className="">
        <p className="" >
          <label htmlFor={id} ref="upload_file" className="pa5 w-100 border-box dib ba b--black-30 navy hover-bg-light-gray pointer">
